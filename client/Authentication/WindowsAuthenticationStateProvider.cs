...
namespace Cpdhelpdesk.Authentication
{
    public class WindowsAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            var token = await jsRuntime.InvokeAsync<string>("sessionStorage.getItem", "CpdhelpdeskToken");
            ...
            if (string.IsNullOrWhiteSpace(token))
            {
                ...
                await jsRuntime.InvokeVoidAsync("sessionStorage.setItem", "CpdhelpdeskToken", token);
            }
