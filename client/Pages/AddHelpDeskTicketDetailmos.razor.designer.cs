...
namespace Cpdhelpdesk.Pages
{
    public partial class AddHelpDeskTicketDetailmosComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            helpdeskticketdetail = new Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicketDetail(){};
            helpdeskticketdetail.HelpDeskTicketId = HelpDeskTicketIdpar;
            helpdeskticketdetail.TicketDetailDate = DateTime.Now;
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicketDetail args)
        {
            try
            {
                helpdeskticketdetail.TicketResponseUser = Security.User.Name;
                helpdeskticketdetail.HelpDeskTicketId = HelpDeskTicketIdpar;
