...
namespace Cpdhelpdesk.Pages
{
    public partial class EditHelpDeskTicketComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicket args)
        {
            ...
            hasChanges = authenticationconnUpdateHelpDeskTicketException.Message.Contains("412");

            if (!authenticationconnUpdateHelpDeskTicketException.Message.Contains("412")) {
                canEdit = false;
            }
            }
        }
