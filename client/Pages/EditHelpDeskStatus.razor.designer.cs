...
namespace Cpdhelpdesk.Pages
{
    public partial class EditHelpDeskStatusComponent : ComponentBase
    {
        ...
        Cpdhelpdesk.Models.Authenticationconn.HelpDeskStatus _helpdeskstatus;
        protected Cpdhelpdesk.Models.Authenticationconn.HelpDeskStatus helpdeskstatus
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Cpdhelpdesk.Models.Authenticationconn.HelpDeskStatus args)
        {
            try
            {
                ...
                if (authenticationconnUpdateHelpDeskStatusResult.StatusCode != System.Net.HttpStatusCode.PreconditionFailed) {
                  DialogService.Close(helpdeskstatus);
                }
            ...
            hasChanges = authenticationconnUpdateHelpDeskStatusException.Message.Contains("412");

            if (!authenticationconnUpdateHelpDeskStatusException.Message.Contains("412")) {
                canEdit = false;
            }
            }
        }
