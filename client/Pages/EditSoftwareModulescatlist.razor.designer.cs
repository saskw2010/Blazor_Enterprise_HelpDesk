...
namespace Cpdhelpdesk.Pages
{
    public partial class EditSoftwareModulescatlistComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var authenticationconnGetSoftwareModulescatlistBysprModulecatidResult = await Authenticationconn.GetSoftwareModulescatlistBysprModulecatid(sprModulecatid:sprModulecatid);
            softwaremodulescatlist = authenticationconnGetSoftwareModulescatlistBysprModulecatidResult;

            canEdit = authenticationconnGetSoftwareModulescatlistBysprModulecatidResult != null;
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Cpdhelpdesk.Models.Authenticationconn.SoftwareModulescatlist args)
        {
            try
            {
                var authenticationconnUpdateSoftwareModulescatlistResult = await Authenticationconn.UpdateSoftwareModulescatlist(sprModulecatid:sprModulecatid, softwareModulescatlist:softwaremodulescatlist);
                if (authenticationconnUpdateSoftwareModulescatlistResult.StatusCode != System.Net.HttpStatusCode.PreconditionFailed) {
                  DialogService.Close(softwaremodulescatlist);
                }

                hasChanges = authenticationconnUpdateSoftwareModulescatlistResult.StatusCode == System.Net.HttpStatusCode.PreconditionFailed;
            }
            ...
            hasChanges = authenticationconnUpdateSoftwareModulescatlistException.Message.Contains("412");

            if (!authenticationconnUpdateSoftwareModulescatlistException.Message.Contains("412")) {
                canEdit = false;
            }
            }
        }
