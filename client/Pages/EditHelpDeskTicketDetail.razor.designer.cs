...
namespace Cpdhelpdesk.Pages
{
    public partial class EditHelpDeskTicketDetailComponent : ComponentBase
    {
        ...
        Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicketDetail _helpdeskticketdetail;
        protected Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicketDetail helpdeskticketdetail
        {
            get
            {
        ...
        Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicket _getByHelpDeskTicketsForHelpDeskTicketIdResult;
        protected Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicket getByHelpDeskTicketsForHelpDeskTicketIdResult
        {
            get
            {
        ...
        IEnumerable<Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicket> _getHelpDeskTicketsForHelpDeskTicketIdResult;
        protected IEnumerable<Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicket> getHelpDeskTicketsForHelpDeskTicketIdResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicketDetail args)
        {
            try
            {
            ...
            hasChanges = authenticationconnUpdateHelpDeskTicketDetailException.Message.Contains("412");

            if (!authenticationconnUpdateHelpDeskTicketDetailException.Message.Contains("412")) {
                canEdit = false;
            }
            }
        }
