...
{
    public partial class IcSoftwareModulescatlistComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Splitbutton0Click(RadzenSplitButtonItem args)
        {
            if (args?.Value == "csv")
            {
                await Authenticationconn.ExportSoftwareModulescatlistsToCSV(new Query() { Filter = $@"{grid0.Query.Filter}", OrderBy = $"{grid0.Query.OrderBy}", Expand = "", Select = "sprModulecatid,sprModulecatDesc,sprModulecatDesc1,FuturecatDesc,FuturecatDesc1,InstallcatModule,photopath,ETag" }, $"Software Modulescatlist");

            }

            if (args == null || args.Value == "xlsx")
            {
                await Authenticationconn.ExportSoftwareModulescatlistsToExcel(new Query() { Filter = $@"{grid0.Query.Filter}", OrderBy = $"{grid0.Query.OrderBy}", Expand = "", Select = "sprModulecatid,sprModulecatDesc,sprModulecatDesc1,FuturecatDesc,FuturecatDesc1,InstallcatModule,photopath,ETag" }, $"Software Modulescatlist");
