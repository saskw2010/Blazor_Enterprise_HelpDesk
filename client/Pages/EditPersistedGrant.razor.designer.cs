...
namespace Cpdhelpdesk.Pages
{
    public partial class EditPersistedGrantComponent : ComponentBase
    {
        ...
        Cpdhelpdesk.Models.Authenticationconn.PersistedGrant _persistedgrant;
        protected Cpdhelpdesk.Models.Authenticationconn.PersistedGrant persistedgrant
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Cpdhelpdesk.Models.Authenticationconn.PersistedGrant args)
        {
            try
            {
            ...
            hasChanges = authenticationconnUpdatePersistedGrantException.Message.Contains("412");

            if (!authenticationconnUpdatePersistedGrantException.Message.Contains("412")) {
                canEdit = false;
            }
            }
        }
