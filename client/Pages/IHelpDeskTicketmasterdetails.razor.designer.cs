...
namespace Cpdhelpdesk.Pages
{
    public partial class IHelpDeskTicketmasterdetailsComponent : ComponentBase
    {
        ...
        protected RadzenDataGrid<Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicketDetail> grid1;
        ...
        protected async System.Threading.Tasks.Task Grid0LoadData(LoadDataArgs args)
        {
            try
            {
                var authenticationconnGetHelpDeskTicketsResult = await Authenticationconn.GetHelpDeskTickets(filter:$@"TicketRequesterUser eq ""{Security.User.Name}"" and contains(TicketStatus,""Closed"")", orderby:$@"{args.OrderBy}", expand:$"HelpDeskStatus,LocationList,ServiceCatglist,ServicesList", top:args.Top, skip:args.Skip, count:args.Top != null && args.Skip != null);
        ...
        protected async System.Threading.Tasks.Task Grid0RowExpand(Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicket args)
        {
            master = args;
