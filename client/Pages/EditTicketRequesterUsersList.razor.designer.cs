...
namespace Cpdhelpdesk.Pages
{
    public partial class EditTicketRequesterUsersListComponent : ComponentBase
    {
        ...
        Cpdhelpdesk.Models.Authenticationconn.TicketRequesterUsersList _ticketrequesteruserslist;
        protected Cpdhelpdesk.Models.Authenticationconn.TicketRequesterUsersList ticketrequesteruserslist
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Cpdhelpdesk.Models.Authenticationconn.TicketRequesterUsersList args)
        {
            try
            {
                ...
                if (authenticationconnUpdateTicketRequesterUsersListResult.StatusCode != System.Net.HttpStatusCode.PreconditionFailed) {
                  DialogService.Close(ticketrequesteruserslist);
                }
            ...
            hasChanges = authenticationconnUpdateTicketRequesterUsersListException.Message.Contains("412");

            if (!authenticationconnUpdateTicketRequesterUsersListException.Message.Contains("412")) {
                canEdit = false;
            }
            }
        }
