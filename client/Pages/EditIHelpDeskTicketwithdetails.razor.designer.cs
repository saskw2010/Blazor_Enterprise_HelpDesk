...
namespace Cpdhelpdesk.Pages
{
    public partial class EditIHelpDeskTicketwithdetailsComponent : ComponentBase
    {
        ...
        protected RadzenDataList<Cpdhelpdesk.Models.Authenticationconn.HelpDeskTicketDetail> datalist0;
        ...
        Cpdhelpdesk.Models.Authenticationconn.HelpDeskStatus _getByHelpDeskStatusesForTicketStatusResult;
        protected Cpdhelpdesk.Models.Authenticationconn.HelpDeskStatus getByHelpDeskStatusesForTicketStatusResult
        {
            get
            {
        ...
        Cpdhelpdesk.Models.Authenticationconn.LocationList _getByLocationListsForlocationIDResult;
        protected Cpdhelpdesk.Models.Authenticationconn.LocationList getByLocationListsForlocationIDResult
        {
            get
            {
        ...
        Cpdhelpdesk.Models.Authenticationconn.ServicesList _getByServicesListsForServiceIDResult;
        protected Cpdhelpdesk.Models.Authenticationconn.ServicesList getByServicesListsForServiceIDResult
        {
            get
            {
        ...
        IEnumerable<Cpdhelpdesk.Models.Authenticationconn.HelpDeskStatus> _getHelpDeskStatusesForTicketStatusResult;
        protected IEnumerable<Cpdhelpdesk.Models.Authenticationconn.HelpDeskStatus> getHelpDeskStatusesForTicketStatusResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            if (Id != null)
            {
                var authenticationconnGetHelpDeskTicketDetailsResult = await Authenticationconn.GetHelpDeskTicketDetails(filter:$@"HelpDeskTicketId eq {Id}", orderby:$@"Id desc");
        ...
        {
            helpdeskticket.TicketResponseUser=Security.User.Name;
        ...
        {
            UriHelper.NavigateTo("icpdhelpdesk");
        }
