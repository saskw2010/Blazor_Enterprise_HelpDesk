...
using Cpdhelpdesk.Pages;

namespace Cpdhelpdesk.Layouts
{
    public partial class WidelayoutmainLayoutComponent : LayoutComponentBase
    {
        [Inject]
...
await InvokeAsync(() => { body0.Toggle(); });
        ...
        protected async System.Threading.Tasks.Task Panelmenu0Click(MenuItemEventArgs args)
        {
            await InvokeAsync(() => { sidebar0.Toggle(); });
