...
namespace Cpdhelpdesk.Controllers.Authenticationconn
{
  ...
  public partial class HelpDeskTicketsController : ODataController
  {
    ...
    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
    [HttpGet("/odata/authenticationconn/HelpDeskTickets(Id={Id})")]
    ...
    [HttpDelete("/odata/authenticationconn/HelpDeskTickets(Id={Id})")]
    ...
    [HttpPut("/odata/authenticationconn/HelpDeskTickets(Id={Id})")]
    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
    ...
    [HttpPatch("/odata/authenticationconn/HelpDeskTickets(Id={Id})")]
    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
