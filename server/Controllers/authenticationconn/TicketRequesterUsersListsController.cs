...
namespace Cpdhelpdesk.Controllers.Authenticationconn
{
  ...
  [Route("odata/authenticationconn/TicketRequesterUsersLists")]
  public partial class TicketRequesterUsersListsController : ODataController
  {
    ...
    partial void OnTicketRequesterUsersListGet(ref SingleResult<Models.Authenticationconn.TicketRequesterUsersList> item);

    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
    [HttpGet("/odata/authenticationconn/TicketRequesterUsersLists(TicketRequesterUser={TicketRequesterUser})")]
    public SingleResult<TicketRequesterUsersList> GetTicketRequesterUsersList(string key)
    {
        var items = this.context.TicketRequesterUsersLists.Where(i=>i.TicketRequesterUser == Uri.UnescapeDataString(key));
        var result = SingleResult.Create(items);

        OnTicketRequesterUsersListGet(ref result);
    ...
    [HttpDelete("/odata/authenticationconn/TicketRequesterUsersLists(TicketRequesterUser={TicketRequesterUser})")]
    public IActionResult DeleteTicketRequesterUsersList(string key)
    {
        try
        {
            ...
            var items = this.context.TicketRequesterUsersLists
                .Where(i => i.TicketRequesterUser == Uri.UnescapeDataString(key))
                .AsQueryable();
    ...
    [HttpPut("/odata/authenticationconn/TicketRequesterUsersLists(TicketRequesterUser={TicketRequesterUser})")]
    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
    public IActionResult PutTicketRequesterUsersList(string key, [FromBody]Models.Authenticationconn.TicketRequesterUsersList newItem)
    {
        try
        {
            ...
            var itemToReturn = this.context.TicketRequesterUsersLists.Where(i => i.TicketRequesterUser == Uri.UnescapeDataString(key));
    ...
    [HttpPatch("/odata/authenticationconn/TicketRequesterUsersLists(TicketRequesterUser={TicketRequesterUser})")]
    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
