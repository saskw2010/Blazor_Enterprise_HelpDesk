...
namespace Cpdhelpdesk.Controllers.Authenticationconn
{
  ...
  [Route("odata/authenticationconn/LocationLists")]
  public partial class LocationListsController : ODataController
  {
    ...
    partial void OnLocationListGet(ref SingleResult<Models.Authenticationconn.LocationList> item);

    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
    [HttpGet("/odata/authenticationconn/LocationLists(locationID={locationID})")]
    ...
    [HttpDelete("/odata/authenticationconn/LocationLists(locationID={locationID})")]
    ...
    [HttpPut("/odata/authenticationconn/LocationLists(locationID={locationID})")]
    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
    ...
    [HttpPatch("/odata/authenticationconn/LocationLists(locationID={locationID})")]
    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
