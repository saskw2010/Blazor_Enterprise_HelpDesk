...
namespace Cpdhelpdesk.Controllers.Authenticationconn
{
  ...
  [Route("odata/authenticationconn/HelpDeskTicketDetails")]
  public partial class HelpDeskTicketDetailsController : ODataController
  {
    ...
    partial void OnHelpDeskTicketDetailGet(ref SingleResult<Models.Authenticationconn.HelpDeskTicketDetail> item);

    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
    [HttpGet("/odata/authenticationconn/HelpDeskTicketDetails(Id={Id})")]
    public SingleResult<HelpDeskTicketDetail> GetHelpDeskTicketDetail(Int64 key)
    {
        ...
        OnHelpDeskTicketDetailGet(ref result);
    ...
    [HttpDelete("/odata/authenticationconn/HelpDeskTicketDetails(Id={Id})")]
    ...
    [HttpPut("/odata/authenticationconn/HelpDeskTicketDetails(Id={Id})")]
    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
    ...
    [HttpPatch("/odata/authenticationconn/HelpDeskTicketDetails(Id={Id})")]
    [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
